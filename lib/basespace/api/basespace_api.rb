...
class BaseSpaceAPI < BaseAPI
  ...
  def get_app_result_files(id, qp = {})
    ...
    header_params  = {}
    verbose        = false
    list_request(my_model, resource_path, method, query_params, header_params, verbose)
  end
  ...
  def get_variant_metadata(id, format)
    ...
    header_params  = {}
    verbose        = false
    single_request(my_model, resource_path, method, query_params, header_params, verbose)
  end
  ...
  def upload_multipart_unit(id, part_number, md5, data)
    resource_path  = "/files/#{id}/parts/#{part_number.to_s}"
    method         = 'PUT'
    query_params   = {}
  ...
  def set_app_session_state(id, status, summary)
    ...
    query_params   = {}
    header_params  = {}
    post_data      = { 'status' => status.downcase, 'statussummary' => summary}
    verbose        = false
